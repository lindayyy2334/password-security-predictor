...
# Example Lottie URLs
success_anim = load_lottieurl("https://assets7.lottiefiles.com/packages/lf20_jbrw3hcz.json")
warning_anim = load_lottieurl("https://assets7.lottiefiles.com/packages/lf20_kxsd2ytq.json")
danger_anim = load_lottieurl("https://assets7.lottiefiles.com/packages/lf20_4kfs6yzz.json")
...
# Sidebar
st.sidebar.title("🔐 Password Fortress")
st.sidebar.markdown("""
Protect your accounts with data-driven password strength predictions.
- Check your password
- Download PDF reports
- Explore Premium & Enterprise plans
""")

# Main Header
st.markdown("""
<div style='background: linear-gradient(90deg, #FF6B81, #FF4C7D); padding:50px; border-radius:15px; text-align:center;'>
    <h1 style='color:white; font-size:48px;'>🔐 Password Fortress</h1>
    <p style='color:white; font-size:20px;'>Free version shows basic score. Premium unlocks advanced analysis. Enterprise is for teams.</p>
</div>
...
if password:
    ...
    # Animation & verdict display
    if verdict == "DANGER":
        st_lottie(danger_anim, height=150)
        st.error(f"{verdict} — Score: {score}/100")
    elif verdict == "WEAK":
        st_lottie(warning_anim, height=150)
...
card_style = "padding:20px; border-radius:15px; box-shadow:2px 2px 15px rgba(0,0,0,0.1); background-color:#FFE6F0; margin-bottom:20px;"
